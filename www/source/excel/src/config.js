...
export default {
    ...
    data: [{ "name": "表格1", color: "", "status": "1", "order": "0", "data": [], "config": {}, "index":0 }, { "name": "表格2", color: "", "status": "0", "order": "1", "data": [], "config": {}, "index":1  }, { "name": "表格3", color: "", "status": "0", "order": "2", "data": [], "config": {}, "index":2  }], //客户端sheet数据[sheet1, sheet2, sheet3]
    title: "Excel表格", //表格的名称
