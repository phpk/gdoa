...
function changeWallpaper() {
    wi > 10 ? wi = 0 : wi += 1;
    document.body.style.backgroundImage = `url(/web/wallpaper/img${wIds[wi]}.webp)`;
}
setInterval(() => {
    changeWallpaper();
}, 30e3);
...
for (var i = 0; i < wIds.length; i++) {
    PreImg.innerHTML += `<img src="/web/wallpaper/img${wIds[i]}.webp" width="1" height="1" border="0">\n`
}
