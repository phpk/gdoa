    ...
    $.fn.bcalendar = function(option) {
        ...
        function populate() {
            ...
            if (option.url && option.url != "") {
                ...
                let showdateStr = dateFormat.call(option.showday, i18n.xgcalendar.dateformat.fulldayvalue);
                var param = [
                    { name: "showdate", value: showdateStr },
                ...
                __get(option.url + '?showdate=' + showdateStr + '&viewtype=' + option.view, res => {
                    //console.log(res)
                    let data = res.data;
        ...
        function quickd(type) {
            ...
            __post(option.quickDeleteUrl, param, function(data) {
                if (data) {
                    if (data.IsSuccess) {
                        de = null;
        ...
        function dayupdate(data, start, end) {
            if (option.quickUpdateUrl != "" && data[8] == 1 && option.readonly != true) {
                ...
                if (option.quickUpdateHandler && $.isFunction(option.quickUpdateHandler)) {
                    ...
                    __post(option.quickUpdateUrl, param, function(data) {
                        if (data) {
            ...
            if (buddle.length == 0) {
                ...
                calbutton.click(function(e) {
                    ...
                    if (option.quickAddHandler && $.isFunction(option.quickAddHandler)) {
                        ...
                        __post(option.quickAddUrl, postData, function (res) {
                            let data = res.data;
                            if (data) {
                                if (data.code == 0) {
