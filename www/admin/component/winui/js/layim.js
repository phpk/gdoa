...
layui.define(['layer', 'laytpl', 'upload', 'winui'], function(exports){
  ...
  var layimClose, popmin = function(content){
    ...
    return layer.open({
      ...
      ,offset: 'rt'
      ,resize: false
      ,content: '<img src="'+ (cache.mine.avatar||(layui.cache.dir+'css/pc/layim/skin/logo.jpg')) +'"><span>'+ (content||cache.base.title||'IM') +'</span>'
      //, content: '<img src="'+ layui.cache.dir + 'css/pc/layim/skin/logo.jpg">'
  ...
  var setChatMin = function(newMsg){
    ...
    setChatMin.index = layer.open({
      ...
      ,success: function(layero, index){
        ...
        layer.style(index, {
          top: document.body.clientHeight - 95 + 'px'
        })
