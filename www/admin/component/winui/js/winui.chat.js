layui.define(['layim', 'layer', 'winui','winuisocket'], function (exports) {
    ...
    const init = () => {
        ...
        */
        ...
        layim.config({
            ...
            //初始化接口
            init: {
                url: winui.path + 'json/getList.json'
                , data: {}
            }
            ...
            */
            ...
            //查看群员接口
            , members: {
                url: winui.path + 'json/getMembers.json'
                , data: {}
            }
