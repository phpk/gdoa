	...
	class iceEditor {
		constructor(id) {
			...
			this.face = [{
				...
				type: 'img',
				list: [
					{title:'嘻嘻',content:'./images/tootha_thumb.gif'},
					{title:'哈哈',content:'./images/laugh.gif'},
					{title:'可爱',content:'./images/tza_thumb.gif'},
					{title:'可怜',content:'./images/kl_thumb.gif'},
					{title:'挖鼻屎',content:'./images/kbsa_thumb.gif'},
					{title:'吃惊',content:'./images/cj_thumb.gif'},
					{title:'害羞',content:'./images/shamea_thumb.gif'},
					{title:'挤眼',content:'./images/zy_thumb.gif'},
					{title:'闭嘴',content:'./images/bz_thumb.gif'},
					{title:'鄙视',content:'./images/bs2_thumb.gif'},
					{title:'爱你',content:'./images/lovea_thumb.gif'},
					{title:'泪',content:'./images/sada_thumb.gif'},
					{title:'偷笑',content:'./images/heia_thumb.gif'},
					{title:'亲亲',content:'./images/qq_thumb.gif'},
					{title:'生病',content:'./images/sb_thumb.gif'},
					{title:'太开心',content:'./images/mb_thumb.gif'},
					{title:'懒得理你',content:'./images/ldln_thumb.gif'},
					{title:'右哼哼',content:'./images/yhh_thumb.gif'},
					{title:'左哼哼',content:'./images/zhh_thumb.gif'},
					{title:'嘘',content:'./images/x_thumb.gif'},
					{title:'衰',content:'./images/cry.gif'},
					{title:'委屈',content:'./images/wq_thumb.gif'},
					{title:'吐',content:'./images/t_thumb.gif'},
					{title:'打哈欠',content:'./images/k_thumb.gif'},
					{title:'抱抱',content:'./images/bba_thumb.gif'},
					{title:'怒',content:'./images/angrya_thumb.gif'},
					{title:'疑问',content:'./images/yw_thumb.gif'},
					{title:'馋嘴',content:'./images/cza_thumb.gif'},
					{title:'拜拜',content:'./images/88_thumb.gif'},
					{title:'思考',content:'./images/sk_thumb.gif'},
					{title:'汗',content:'./images/sweata_thumb.gif'},
					{title:'困',content:'./images/sleepya_thumb.gif'},
					{title:'睡觉',content:'./images/sleepa_thumb.gif'},
					{title:'钱',content:'./images/money_thumb.gif'},
					{title:'失望',content:'./images/sw_thumb.gif'},
					{title:'酷',content:'./images/cool_thumb.gif'},
					{title:'花心',content:'./images/hsa_thumb.gif'},
					{title:'哼',content:'./images/hatea_thumb.gif'},
					{title:'鼓掌',content:'./images/gza_thumb.gif'},
					{title:'晕',content:'./images/dizzya_thumb.gif'},
					{title:'悲伤',content:'./images/bs_thumb.gif'},
					{title:'抓狂',content:'./images/crazya_thumb.gif'},
					{title:'黑线',content:'./images/h_thumb.gif'},
					{title:'阴险',content:'./images/yx_thumb.gif'},
					{title:'怒骂',content:'./images/nm_thumb.gif'},
					{title:'心',content:'./images/hearta_thumb.gif'},
					{title:'伤心',content:'./images/unheart.gif'},
					{title:'ok',content:'./images/ok_thumb.gif'},
					{title:'耶',content:'./images/ye_thumb.gif'},
					{title:'good',content:'./images/good_thumb.gif'},
					{title:'不要',content:'./images/no_thumb.gif'},
					{title:'赞',content:'./images/z2_thumb.gif'},
					{title:'来',content:'./images/come_thumb.gif'},
					{title:'弱',content:'./images/sad_thumb.gif'},
					{title:'蜡烛',content:'./images/lazu_thumb.gif'},
					{title:'蛋糕',content:'./images/cake.gif'}
				]
			},{
				title: '文字',
				type: 'text',
