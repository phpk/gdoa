...
var textClickStatus = false; // 工具栏超出截图容器状态

var toolPositionStatus = false; // 裁剪框位置参数
...
var cutBoxSizeContainer = null; // 获取文本输入区域dom
...
var InitData_InitData = /*#__PURE__*/function () {
  ...
  _createClass(InitData, [{
    ...
    value: function setCutBoxSize(width, height) {
      if (cutBoxSizeContainer == null) return;
      var childrenPanel = cutBoxSizeContainer.childNodes; // p标签已存在直接更改文本值即可
    ...
    value: function setToolInfo(left, top) {
      InitData_toolController = document.getElementById("toolPanel");
      InitData_toolController.style.left = left + "px";
      InitData_toolController.style.top = top + "px";
    } // 获取截图工具栏点击状态
    ...
    value: function destroyDOM() {
      if (InitData_screenShortController == null || InitData_toolController == null || optionIcoController == null || optionController == null || InitData_textInputController == null || cutBoxSizeContainer == null) return; // 销毁dom
...
function saveCanvasToBase64(context, startX, startY, width, height) {
  ...
  if (imgContext) {
    // 将图片放进canvas中
    imgContext.putImageData(img, 0, 0); // 将图片自动添加至剪贴板中

    canvas === null || canvas === void 0 ? void 0 : canvas.toBlob(function (blob) {
      var _navigator$clipboard;

      if (blob == null) return;
      var Clipboard = window.ClipboardItem; // 浏览器不支持Clipboard
...
function getCanvasImgData(isSave) {
  ...
  var data = new InitData_InitData();
  var screenShortCanvas = (_data$getScreenShotCo = data.getScreenShotContainer()) === null || _data$getScreenShotCo === void 0 ? void 0 : _data$getScreenShotCo.getContext("2d"); // 获取裁剪区域位置信息
...
var PlugInParameters_canvasHeight = 0; // 展示截屏图片至容器
...
function toolClickEvent(toolName, index, mouseEvent, completeCallback, closeCallback) {
  ...
  var screenShortController = data.getScreenShotContainer();
  ...
  if (!data.getToolClickStatus()) {
    ...
    var topValue = ((_data$getToolPosition2 = data.getToolPosition()) === null || _data$getToolPosition2 === void 0 ? void 0 : _data$getToolPosition2.top) || 0; // 工具栏位置超出时，对其进行修正处理
    ...
    data.setToolStatus(true); // 获取裁剪框位置信息
...
var CreateDom_CreateDom = /*#__PURE__*/function () {
  ...
  function CreateDom(options) {
    ...
    _defineProperty(this, "screenShortController", void 0);
    ...
    this.hiddenIcoArr = []; // 成功回调函数不存在则设置一个默认的
  ...
  _createClass(CreateDom, [{
    ...
    value: function setToolBarIco() {
      ...
      var _loop = function _loop(i) {
        var item = _this.toolbar[i]; // 判断是否有需要隐藏的图标
...
function drawMasking(context, imgData) {
  var plugInParameters = new PlugInParameters_PlugInParameters(); // 清除画布

  context.clearRect(0, 0, window.innerWidth, window.innerHeight); // 屏幕截图存在且展示截图数据的状态为true则进行绘制
...
var KeyboardEventHandle_KeyboardEventHandle = /*#__PURE__*/function () {
  // 截图工具栏容器
  function KeyboardEventHandle(screenShortController, toolController) {
    var _this = this;
    ...
    this.toolController = toolController; // 调整截图容器显示权重

    screenShortController.tabIndex = 9999; // 监听截图容器键盘按下事件

    screenShortController.addEventListener("keydown", function (event) {
...
function setPlugInParameters(options) {
  var plugInParameters = new PlugInParameters_PlugInParameters(); // webrtc启用状态, 默认为true，如果设置了false则修改默认值
...
var main_ScreenShort = /*#__PURE__*/function () {
  ...
  function ScreenShort(options) {
    ...
    _defineProperty(this, "screenShortImageController", void 0);

    _defineProperty(this, "screenShortCanvas", void 0);
    ...
    _defineProperty(this, "screenShot", function (cancelCallback) {
      // 开始捕捉屏幕
      _this.startCapture(cancelCallback).then(function () {
        setTimeout(function () {
          var _this$screenShotConta, _this$screenShortImag, _this$screenShortImag2, _this$screenShortImag3;

          // 获取截图区域canvas容器画布
          var context = (_this$screenShotConta = _this.screenShotContainer) === null || _this$screenShotConta === void 0 ? void 0 : _this$screenShotConta.getContext("2d");
          if (context == null || _this.screenShotContainer == null) return; // 赋值截图区域canvas画布
          ...
          (_this$screenShortImag3 = _this.screenShortImageController.getContext("2d")) === null || _this$screenShortImag3 === void 0 ? void 0 : _this$screenShortImag3.drawImage(_this.videoController, 0, 0, containerWidth, containerHeight); // 初始化截图容器

          _this.initScreenShot(undefined, context, _this.screenShortImageController); // 停止捕捉屏幕
    ...
    _defineProperty(this, "mouseDownEvent", function (event) {
      ...
      _this.drawStatus = false; // 重置工具栏超出状态
      ...
      if (_this.data.getToolName() == "text" && _this.textInputController && _this.screenShotContainer && _this.screenShortCanvas) {
        // 修改鼠标样式
        _this.screenShotContainer.style.cursor = "text"; // 显示文本输入区域
        ...
        if (_this.textInputPosition.mouseX != 0 && _this.textInputPosition.mouseY != 0 && _this.textInputPosition.mouseX != mouseX && _this.textInputPosition.mouseY != mouseY) {
          drawText(_this.textInputController.innerText, _this.textInputPosition.mouseX, _this.textInputPosition.mouseY, _this.data.getSelectedColor(), _this.fontSize, _this.screenShortCanvas); // 输入框内容不为空时则隐藏
    ...
    _defineProperty(this, "mouseMoveEvent", function (event) {
      if (_this.screenShortCanvas == null || _this.screenShotContainer == null || _this.data.getToolName() == "undo") {
        return;
      } // 工具栏未选择且鼠标处于按下状态时
      ...
      if (!_this.data.getToolClickStatus() && _this.data.getDragging()) {
        ...
        _this.data.setToolStatus(false); // 隐藏裁剪框尺寸显示容器
      ...
      if (_this.data.getToolClickStatus() && _this.data.getDragging()) {
        ...
        switch (_this.data.getToolName()) {
          case "square":
            drawRectangle(startX, startY, tempWidth, tempHeight, _this.data.getSelectedColor(), _this.data.getPenSize(), _this.screenShortCanvas, _this.screenShotContainer, _this.screenShortImageController);
            break;
      ...
      _this.tempGraphPosition = drawCutOutBox(startX, startY, tempWidth, tempHeight, _this.screenShortCanvas, _this.data.getBorderSize(), _this.screenShotContainer, _this.screenShortImageController);
    });
    ...
    _defineProperty(this, "mouseUpEvent", function () {
      ...
      if (_this.screenShortCanvas == null || _this.screenShotContainer == null) {
        return;
      ...
      if (cutBoxPosition.width === 0 && cutBoxPosition.height === 0 && cutBoxPosition.startX === 0 && cutBoxPosition.startY === 0 && !_this.dragFlag && _this.clickCutFullScreen) {
        ...
        _this.getFullScreenStatus = true; // 设置裁剪框位置为全屏

        _this.tempGraphPosition = drawCutOutBox(0, 0, _this.screenShotContainer.width - borderSize / 2, _this.screenShotContainer.height - borderSize / 2, _this.screenShortCanvas, borderSize, _this.screenShotContainer, _this.screenShortImageController);
      }

      if (_this.screenShotContainer == null || _this.screenShortCanvas == null) {
        return;
      } // 工具栏已点击且进行了绘制
      ...
      if (_this.screenShotContainer != null) {
        // 修改鼠标状态为拖动
        _this.screenShotContainer.style.cursor = "move"; // 显示截图工具栏

        _this.data.setToolStatus(true); // 显示裁剪框尺寸显示容器


        _this.data.setCutBoxSizeStatus(true); // 复原拖动状态
        ...
        if (_this.toolController != null) {
          // 计算截图工具栏位置
          var toolLocation = calculateToolLocation(_this.drawGraphPosition, _this.toolController.offsetWidth);
          var containerHeight = _this.screenShotContainer.height; // 当前截取的是全屏，则修改工具栏的位置到截图容器最底部，防止超出
          ...
          if (toolLocation.mouseY > containerHeight - 64) {
            toolLocation.mouseY -= _this.drawGraphPosition.height + 64; // 设置工具栏超出状态为true

            _this.data.setToolPositionStatus(true); // 隐藏裁剪框尺寸显示容器
          ...
          _this.data.setToolInfo(toolLocation.mouseX + _this.position.left, toolLocation.mouseY + _this.position.top); // 设置裁剪框尺寸显示容器位置


          _this.data.setCutBoxSizePosition(_this.drawGraphPosition.startX, _this.drawGraphPosition.startY - 35); // 渲染裁剪框尺寸


          _this.data.setCutBoxSize(_this.drawGraphPosition.width, _this.drawGraphPosition.height); // 状态重置
    ...
    setPlugInParameters(options); // 创建截图所需dom并设置回调函数

    new CreateDom_CreateDom(options); // 创建并获取webrtc模式所需要的辅助dom
    ...
    this.data = new InitData_InitData(); // 单击截取全屏启用状态,默认为false
    ...
    this.cutBoxSizeContainer = this.data.getCutBoxSizeContainer(); // 加载截图组件
    ...
    if (this.toolController == null || this.screenShotContainer == null || this.optionIcoController == null || this.optionController == null || this.cutBoxSizeContainer == null || this.textInputController == null) {
      return;
    } // 调整层级


    if (options !== null && options !== void 0 && options.level) {
      this.screenShotContainer.style.zIndex = "".concat(options.level);
      this.toolController.style.zIndex = "".concat(options.level + 1);
      this.textInputController.style.zIndex = "".concat(options.level + 1);
      this.optionIcoController.style.zIndex = "".concat(options.level + 1);
      this.optionController.style.zIndex = "".concat(options.level + 1);
      this.cutBoxSizeContainer.style.zIndex = "".concat(options.level + 1);
    } // 创建键盘事件监听
  ...
  _createClass(ScreenShort, [{
    ...
    value: function load(triggerCallback, cancelCallback) {
      ...
      var context = (_this$screenShotConta2 = this.screenShotContainer) === null || _this$screenShotConta2 === void 0 ? void 0 : _this$screenShotConta2.getContext("2d");
      ...
      if (!plugInParameters.getWebRtcStatus()) {
        ...
        if (this.imgSrc != null) {
          ...
          imgContainer.onload = function () {
            var _this2$screenShortIma;

            // 装载截图的dom为null则退出
            if (_this2.screenShotContainer == null) return; // 将用户传递的图片绘制到图片容器里

            (_this2$screenShortIma = _this2.screenShortImageController.getContext("2d")) === null || _this2$screenShortIma === void 0 ? void 0 : _this2$screenShortIma.drawImage(imgContainer, 0, 0, _this2.screenShortImageController.width, _this2.screenShortImageController.height); // 初始化截图容器

            _this2.initScreenShot(triggerCallback, context, _this2.screenShortImageController);
          };
        ...
        html2canvas_default()(document.body, {
          ...
          // 装载截图的dom为null则退出
          if (_this2.screenShotContainer == null) return; // 存储html2canvas截取的内容

          _this2.screenShortImageController = canvas; // 初始化截图容器
    ...
    function operatingCutOutBox(currentX, currentY, startX, startY, width, height, context) {
      ...
      if (this.cutOutBoxBorderArr.length > 0 && !this.data.getDraggingTrim()) {
        ...
        if (!flag) {
          // 鼠标移出裁剪框重置鼠标样式
          this.screenShotContainer.style.cursor = "default"; // 重置当前操作的边框节点为null
      ...
      if (this.data.getDraggingTrim()) {
        ...
        if (this.borderOption === 1) {
          // 计算要移动的x轴坐标
          var x = fixedData(currentX - (moveStartX - startX), width, this.screenShotContainer.width); // 计算要移动的y轴坐标

          var y = fixedData(currentY - (moveStartY - startY), height, this.screenShotContainer.height); // 重新绘制裁剪框

          this.tempGraphPosition = drawCutOutBox(x, y, width, height, context, this.data.getBorderSize(), this.screenShotContainer, this.screenShortImageController);
        } else {
          // 裁剪框其他8个点的拖拽事件
          ...
          this.tempGraphPosition = drawCutOutBox(tempStartX, tempStartY, tempWidth, tempHeight, context, this.data.getBorderSize(), this.screenShotContainer, this.screenShortImageController);
        }
      }
    }
    /**
    ...
    value: function initScreenShot(triggerCallback, context, screenShotContainer) {
      var _this$screenShotConta3, _this$screenShotConta4, _this$screenShotConta5;
      ...
      this.screenShortCanvas = context; // 存储屏幕截图

      this.data.setScreenShortImageController(screenShotContainer); // 绘制蒙层

      drawMasking(context, screenShotContainer); // 添加监听

      (_this$screenShotConta3 = this.screenShotContainer) === null || _this$screenShotConta3 === void 0 ? void 0 : _this$screenShotConta3.addEventListener("mousedown", this.mouseDownEvent);
      (_this$screenShotConta4 = this.screenShotContainer) === null || _this$screenShotConta4 === void 0 ? void 0 : _this$screenShotConta4.addEventListener("mousemove", this.mouseMoveEvent);
      (_this$screenShotConta5 = this.screenShotContainer) === null || _this$screenShotConta5 === void 0 ? void 0 : _this$screenShotConta5.addEventListener("mouseup", this.mouseUpEvent);
    }
    /**
     * 保存当前画布状态
     * @private
