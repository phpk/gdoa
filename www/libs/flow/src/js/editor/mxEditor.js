...
function mxEditor(config)
{
	...
	if (document.body != null)
	{
		...
		if (urlParams['id']) {
			new mxXmlRequest('/group/flow/editBefore?id=' + urlParams['id'], '', 'get').send(res => {
				//console.log(res)
...
mxEditor.prototype.save = function (url, linefeed)
{
	...
	if (!urlParams['id']) {
		new mxXmlRequest('/group/flow/add', 'title=' + encodeURIComponent(name) +
		...
		new mxXmlRequest('/group/flow/edit', 'title=' + encodeURIComponent(name) +
