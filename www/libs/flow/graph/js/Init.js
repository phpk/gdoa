...
window.SAVE_URL = window.SAVE_URL || '/group/flow/add';
...
window.OPEN_FORM = window.OPEN_FORM || '/libs/flow/graph/open.html';
...
window.mxBasePath = window.mxBasePath || '/libs/flow/src';
