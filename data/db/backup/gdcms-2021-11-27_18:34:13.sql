...
CREATE TABLE `rt_admin_oplog` (
  ...
  `addtime` int(10) unsigned DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 297 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理操作日志';
...
CREATE TABLE `rt_admin_viewlog` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 359 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员查看日志';
...
CREATE TABLE `rt_doc` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '唯一标志',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '文集标题',
  `title` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '文集副标题',
...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: rt_doc_list
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rt_doc_list`;
CREATE TABLE `rt_doc_list` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '唯一标志',
...
) ENGINE = InnoDB AUTO_INCREMENT = 144 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统菜单';
...
VALUES
  (
    'admin',
    'c4d17eece47c648dea34b4570c1b5954',
    1,
    'E6HGttcNnt6KcGtH',
    0,
    NULL,
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: rt_doc_list
# ------------------------------------------------------------
