...
# ------------------------------------------------------------
# SCHEMA DUMP FOR TABLE: rt_achievement_copy
# ------------------------------------------------------------

DROP TABLE IF EXISTS `rt_achievement_copy`;
CREATE TABLE `rt_achievement_copy` (
  `achievement_id` int(10) NOT NULL AUTO_INCREMENT COMMENT '555',
  `order_id` int(10) unsigned DEFAULT NULL COMMENT '订单id',
  `product_id` int(10) unsigned DEFAULT '0' COMMENT '商品id',
  `group_id` int(10) unsigned DEFAULT '0' COMMENT '集团id',
...
CREATE TABLE `rt_admin_oplog` (
  ...
  `addtime` int(10) unsigned DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 248 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理操作日志';
...
CREATE TABLE `rt_admin_viewlog` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 275 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员查看日志';
...
) ENGINE = InnoDB AUTO_INCREMENT = 116 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统菜单';
...
# ------------------------------------------------------------
# DATA DUMP FOR TABLE: rt_achievement_copy
# ------------------------------------------------------------
...
VALUES
  (
    'admin',
    '6313f5a40a0249ee35fc3a4613dd214e',
    1,
    '6fa87KNcjy32EWZY',
    0,
    NULL,
