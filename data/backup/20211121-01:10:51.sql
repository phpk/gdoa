...
CREATE TABLE `rt_admin_oplog` (
  ...
  `addtime` int(10) unsigned DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 234 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理操作日志';
...
CREATE TABLE `rt_admin_viewlog` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 248 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员查看日志';
...
CREATE TABLE `rt_article` (
  ...
  `title` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '文章标题',
...
) ENGINE = InnoDB AUTO_INCREMENT = 107 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '系统菜单';
...
VALUES
  (
    'admin',
    '173176fbb68d493b7f2568f07876512d',
    1,
    'kTYSHCNyd8jXpCSe',
    0,
    NULL,
