...
module.exports = class extends Base {
    ...
    async addAction() {
        let post = this.post();
        let key = post.key;
        let sys = ['mod','doc','api', 'ppt', 'mind','excel', 'flow', 'index', 'set','base','cate'];
    ...
    async editAction() {
		...
		await this.model('menu').cacheDataByUid(this.userId);
        return this.success()
    }
    /**
